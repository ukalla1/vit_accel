...
HD_PWD='C:/work/research/Accelerator/VIT/vit_accel/vit_accel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_col.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_col.tcl
