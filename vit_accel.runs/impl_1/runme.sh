...
HD_PWD='C:/work/research/Accelerator/VIT/vit_accel/vit_accel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PE_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PE_wrapper.tcl -notrace
